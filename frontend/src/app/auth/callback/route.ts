...
/**
 * Determine a user's role based on their email and WorkOS org membership.
 * In a real multi-tenant setup this would query Convex for an existing
 * user record. For now we use a simple heuristic.
 */
