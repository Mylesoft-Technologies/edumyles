...
export default function SystemHealthPage() {
  ...
  const resourceUsage = {
    current: {
      cpu: { overall: 45.6, cores: [42.1, 48.9, 44.2, 47.3] },
      memory: { total: "32GB", used: "21.7GB", available: "10.3GB", percentage: 67.8 },
      disk: { total: "500GB", used: "171GB", available: "329GB", percentage: 34.2 },
      network: { incoming: "45.2MB/s", outgoing: "23.8MB/s", totalRequests: 12450 },
    },
  };
